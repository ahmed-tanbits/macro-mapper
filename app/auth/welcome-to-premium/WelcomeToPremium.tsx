      ...
      <section className="grid grid-cols-12">
        <div className="col-span-12 sm:col-span-7 992:col-span-5 w-full p-4 lg:p-16 bg-[#09BE06] sm:bg-white h-screen overflow-x-auto">
          <div className="w-full mx-auto bg-white p-4 rounded-2xl ">
            ...
            <h2 className="text-[#2E3139] text-xl md:text-3xl font-bold pb-4 text-center">
              Subscription activated
            </h2>
            <p className="text-[#425583] text-center text-sm md:text-base pb-4">
            ...
            <ul className="flex flex-col gap-4 sm:gap-5">
              <li className="mt-1">
                <Link
                  href={""}
                  className="block w-full text-white border border-[#0AC600] bg-[#0AC600] font-bold rounded-lg py-3 text-center"
                >
                  Search MacroMapper
                </Link>
              </li>
              <li className="mt-1">
                <Link
                  href={""}
                  className="block w-full text-black border border-black bg-[#f8f8f8] font-bold rounded-lg py-3 text-center"
                >
                  View Profile
                </Link>
              </li>

...
type ResponsiveCusCheckboxProps = {
  options: CheckboxOption[];
  label: string;
  onSelectionChange: (selectedOptions: CheckboxOption[]) => void;
};

const ResponsiveCusCheckbox: React.FC<ResponsiveCusCheckboxProps> = ({
  ...
  return (
    <div className="whitespace-nowrap" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 mt-3 bg-white border overflow-clip border-neutral-200 shadow-xl rounded-xl max-w-md w-full left-1/2 transform -translate-x-1/2">
...
export default ResponsiveCusCheckbox;

...
const SearchBarResponsive: React.FC<Props> = ({ onSearch }) => {
  ...
  useEffect(() => {
    ...
    if (suggested) {
      ...
      router.replace(`${window.location.pathname}?${params.toString()}`, undefined);
    }
    ...
    >
      <div className="flex justify-center items-center gap-3">
        ...
        <input
          ...
          className="w-full h-full absolute z-10 right-0 pl-12 bg-transparent outline-none"
